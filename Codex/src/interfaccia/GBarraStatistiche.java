...
public class GBarraStatistiche extends JPanel{
	...
	public GBarraStatistiche(String nomeGiocatore) {
		...
		this.nomeGiocatore.setFont(new Font("Segoe UI Black", Font.PLAIN, 24));
		...
		this.nomeGiocatore.setPreferredSize(new Dimension(500,300));
		
		this.descrizioneAzione = new JLabel();
		this.descrizioneAzione.setFont(new Font("Segoe UI Black", Font.PLAIN, 16));
		...
		this.descrizioneAzione.setPreferredSize(new Dimension(500,300));
	...
	private void createContatore(JLabel contatore){
		...
		contatore.setText("0");
		contatore.setFont(new Font("Segoe UI Black", Font.PLAIN, 20));
